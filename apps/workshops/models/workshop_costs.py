...
class WorkshopCost(TimeStampedModel):
    ...
    work_hours_per_day = models.DurationField(verbose_name="Horas de trabalho/dia", validators=[MinValueValidator(timedelta()), MaxValueValidator(timedelta(hours=24))], default=8)
