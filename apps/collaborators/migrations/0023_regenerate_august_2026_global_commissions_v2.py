...
def _regenerate_august_2026_global_commissions_v2(apps, schema_editor) -> None:
...
class Migration(migrations.Migration):
    dependencies = [
        ("collaborators", "0022_regenerate_august_2026_global_commissions"),
        ("workorder", "0047_workorder_courtesy_reason_fields"),
    ]

    operations = [
        migrations.RunPython(_regenerate_august_2026_global_commissions_v2, migrations.RunPython.noop),
    ]
