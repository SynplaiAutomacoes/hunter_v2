...
STOCK_REPORT_COLUMN_DEFINITIONS: tuple[StockReportColumnDefinition, ...] = (
    StockReportColumnDefinition(
        key="code",
        label="Codigo",
        table_column=TableColumn("Codigo", attr="product.code", sort_by="product__code"),
    ...
    StockReportColumnDefinition(
        key="piece",
        label="Peca",
        table_column=TableColumn("Peca", attr="product.name", sort_by="product__name"),
    ...
    StockReportColumnDefinition(
        ...
        table_column=TableColumn("Custo unitario", attr="unit_cost", th_class="text-right", td_class="text-right", searchable=False, sort_by="product__cost_price", format="money_br"),
    ...
    StockReportColumnDefinition(
        key="location",
        label="Localizacao",
        table_column=TableColumn("Localizacao", attr="product.location", sort_by="product__location"),
    ...
    StockReportColumnDefinition(
        ...
        table_column=TableColumn("Estoque minimo", attr="minimum_quantity", th_class="text-right", td_class="text-right", searchable=False),
    ...
    StockReportColumnDefinition(
        ...
        label="Reposicao",
        table_column=TableColumn("Reposicao", attr="restock_quantity", th_class="text-right", td_class="text-right", searchable=False),
