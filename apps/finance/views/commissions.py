            ...
            rows.append(
                {
                    ...
                    "workorder_id": entry.workorder.budget_id if entry.workorder_id else None,
                    "workorder_url": reverse("workorder:workorder_detail", kwargs={"pk": entry.workorder_id}) if entry.workorder_id else "",
