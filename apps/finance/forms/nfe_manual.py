...
class NfeManualEmissionForm(CoreForm):
    ...
    product: forms.ModelChoiceField = forms.ModelChoiceField(label="Produto", queryset=Product.objects.none(), widget=SearchableSelectInput())
    ...
    def clean(self) -> dict[str, Any]:
        ...
        if isinstance(product, Product) and product.workshop_id != workshop_id:
            self.add_error("product", "O produto pertence a outra oficina.")
