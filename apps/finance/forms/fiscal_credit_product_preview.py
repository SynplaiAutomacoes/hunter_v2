...
class FiscalCreditProductPreviewCreateForm(CoreForm):
    ...
    explicit_value_confirmation = forms.BooleanField(
        label="Confirmo que quantidade, valor unitário, total e CFOP foram definidos explicitamente para esta prévia",
        required=True,
    ...
    def __init__(self, *args, workshop, **kwargs) -> None:
        ...
        self.fields["product_quantity"].help_text = "Não ha quantidade padrão. Informe somente mediante criterio fiscal explicito."
