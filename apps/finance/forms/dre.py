...
class DreForm(forms.Form):
    ...
    data_inicial = forms.DateField(widget=CalendarDateInput(), required=False, label="Data Inicial")

    data_final = forms.DateField(widget=CalendarDateInput(), required=False, label="Data Final")
