...
def configure_nfe_transport_form(*, form: forms.BaseForm, snapshot: object = None, freight_mode: object = 9) -> None:
    ...
    form.fields["transport_state_registration"] = forms.CharField(label="Inscricao estadual", required=False, max_length=20, widget=TextInput())
    ...
    form.fields["transport_volume_quantity"] = forms.IntegerField(label="Quantidade de volumes", required=False, min_value=1, max_value=15, widget=NumberInput())
