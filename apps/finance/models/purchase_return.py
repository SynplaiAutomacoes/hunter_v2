...
class PurchaseReturnRequestItem(TimeStampedModel):
    ...
    source_item = models.ForeignKey("stock.StockImportFiscalItem", on_delete=models.PROTECT, related_name="purchase_return_items", verbose_name="Item fiscal de origem")
    ...
    class Meta(TimeStampedModel.Meta):
        ...
        constraints = [models.UniqueConstraint(fields=["request", "source_item"], name="unique_purchase_return_source_item")]
