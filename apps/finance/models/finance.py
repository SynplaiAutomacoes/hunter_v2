...
class TaxClassNfse(TimeStampedModel):
    ...
    modelo = models.CharField(verbose_name="Modelo NFS-e", max_length=32, blank=True, default="")
    tipo_emissao = models.CharField(verbose_name="Tipo de emissão", max_length=10, blank=True, default="")
    codigo_servico_cliente = models.CharField(verbose_name="Código do serviço do cliente", max_length=20, blank=True, default="")
    ...
    identificador_beneficio_municipal = models.CharField(verbose_name="Identificador benefício municipal", max_length=14, blank=True, default="")
    pis_cofins_retido = models.CharField(verbose_name="PIS/COFINS retido", max_length=10, blank=True, default="")
    data_competencia = models.CharField(verbose_name="Data da competência", max_length=10, blank=True, default="")
    codigo_interno = models.CharField(verbose_name="Código interno", max_length=20, blank=True, default="")
    ...
    codigo_nbs = models.CharField(verbose_name="Código NBS", max_length=9, blank=True, default="")
    uf_local_prestacao = models.CharField(verbose_name="UF local da prestação", max_length=2, blank=True, default="")
    cidade_local_prestacao = models.CharField(verbose_name="Cidade local da prestação", max_length=25, blank=True, default="")
    ...
    aliquota_tributos_aproximados = models.DecimalField(verbose_name="Alíquota tributos aproximados", max_digits=7, decimal_places=2, null=True, blank=True)
