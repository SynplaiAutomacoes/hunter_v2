...
# state. After it landed on homol/staging, Django still believed the fields
# existed (AddField migrations in the fiscal graph), but Postgres no longer
# had the columns. Queries such as Workshop.pdf_name then failed with
