...
class NfeTransportPayloadTests(SimpleTestCase):
    ...
    def test_preview_and_emission_use_same_frozen_transport(self) -> None:
        ...
        self.assertEqual(emission_payload["transporte"]["reboque"], TRANSPORT_SNAPSHOT_WITH_TRAILERS["reboques"])

        nfe_request.transport_snapshot["transportador"]["razao_social"] = "Alterada depois"
        self.assertEqual(emission_payload["transporte"]["razao_social"], "Transportadora teste")
