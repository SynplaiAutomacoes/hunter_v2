...
urlpatterns = [
    ...
    path("folha-pagamento/<int:pk>/historico-comissoes/", PayrollCommissionHistoryPartialView.as_view(), name="payroll_commission_history_partial"),
    ...
    path("comissoes/excel/", CommissionReportExcelView.as_view(), name="commission_report_excel"),
    ...
    path("nfe/<int:pk>/apagar/", NfeRequestSoftDeleteView.as_view(), name="nfe_soft_delete"),
    ...
    path("nfe/devolucao/", PurchaseReturnCreateView.as_view(), name="purchase_return_create"),
    path("nfe/devolucao/<int:pk>/", PurchaseReturnWorkflowView.as_view(), name="purchase_return_workflow"),
    path("nfe/devolucao/<int:pk>/preview/", PurchaseReturnPreviewView.as_view(), name="purchase_return_preview"),
    path("nfe/devolucao/<int:pk>/preview/pdf/", PurchaseReturnPreviewPdfView.as_view(), name="purchase_return_preview_pdf"),
    path("nfe/devolucao/<int:pk>/transmitir/", PurchaseReturnTransmitView.as_view(), name="purchase_return_transmit"),
    path("nfe/devolucao/<int:pk>/reconciliar/", PurchaseReturnReconcileView.as_view(), name="purchase_return_reconcile"),
    path("nfe/devolucao/<int:pk>/emitir-novamente/", PurchaseReturnReissueView.as_view(), name="purchase_return_reissue"),
    ...
    path("nfse/<int:pk>/apagar/", NfseRequestSoftDeleteView.as_view(), name="nfse_soft_delete"),
