...
urlpatterns = [
    ...
    path("emissao/normal/manual/<int:pk>/transmitir/", NfeManualTransmissionView.as_view(), name="emission_manual_transmit"),
    path("emissao/normal/manual/produto/cadastro-rapido/", NfeManualQuickProductCreateView.as_view(), name="emission_manual_quick_product"),
    ...
    path("emissao/devolucao-compra/", PurchaseReturnCreateView.as_view(), name="purchase_return_create"),
    path("emissao/devolucao-compra/<int:pk>/", PurchaseReturnWorkflowView.as_view(), name="purchase_return_workflow"),
    path("emissao/devolucao-compra/<int:pk>/previa/", PurchaseReturnPreviewView.as_view(), name="purchase_return_preview"),
    path("emissao/devolucao-compra/<int:pk>/previa/pdf/", PurchaseReturnPreviewPdfView.as_view(), name="purchase_return_preview_pdf"),
    path("emissao/devolucao-compra/<int:pk>/transmitir/", PurchaseReturnTransmitView.as_view(), name="purchase_return_transmit"),
    path("emissao/transporte/", TransportCreateView.as_view(), name="transport_create"),
    path("emissao/transporte/<int:pk>/", TransportWorkflowView.as_view(), name="transport_workflow"),
    path("emissao/transporte/<int:pk>/previa/", TransportPreviewView.as_view(), name="transport_preview"),
    path("emissao/transporte/<int:pk>/previa/pdf/", TransportPreviewPdfView.as_view(), name="transport_preview_pdf"),
    path("emissao/transporte/<int:pk>/transmitir/", TransportTransmitView.as_view(), name="transport_transmit"),
