...
class FipeVehicleBrand(TimeStampedModel):
    ...
    class Meta:  # pyright: ignore[reportIncompatibleVariableOverride]
        ...
        constraints = [models.UniqueConstraint(fields=("vehicle_type", "external_id"), name="unique_fipe_brand_per_type")]
        ordering = ("name",)
...
class FipeVehicleModel(TimeStampedModel):
    ...
    class Meta:  # pyright: ignore[reportIncompatibleVariableOverride]
        ...
        constraints = [models.UniqueConstraint(fields=("vehicle_type", "brand", "external_id"), name="unique_fipe_model_per_brand")]
        ordering = ("name",)
...
class FipeModelFuelCache(TimeStampedModel):
    ...
    class Meta:  # pyright: ignore[reportIncompatibleVariableOverride]
        ...
        constraints = [models.UniqueConstraint(fields=("vehicle_type", "model"), name="unique_fipe_fuel_cache_per_model")]
