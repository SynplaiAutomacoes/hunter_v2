...
Fase atual: Fase 3.12.1 - Manifestacao de NFS-e Recebida, validada tecnicamente em 2026-06-29. A Fase 3.12.0 foi validada documentalmente no checkpoint `a5b4f4b`. A Fase 3.12.1 implementou manifestacao de NFS-e recebida como extensao segura de `NfseManifestation`, somente para `NfseReceivedDocument` validado, roles `taker`/`intermediary`, UUID seguro, XML validado, Padrao Nacional e `manifestation_enabled=True`. Manifestacao da NFS-e manual continua adiada; NFS-e recebida permanece sem emissao, cancelamento ou substituicao nesta fase.
...
| 3.12.1 - Manifestacao NFS-e recebida | validada tecnicamente | `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `06-prd-ux-permissoes-e-workflows.md`, `08-plano-de-testes-e-operacao.md` | 2026-06-29 | 2026-06-29 | Migration `0070`; somente `NfseReceivedDocument` validado; sem manual, emissao, cancelamento ou substituicao de recebida |
