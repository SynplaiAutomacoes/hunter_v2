...
Fase atual: Fase 3.17.0 - Fechamento do Bloco NFS-e Recebida e Reavaliacao do Proximo Eixo Fiscal, em planejamento documental em 2026-06-30. A Fase 3.16.1 foi validada e encerrada no checkpoint `166eda86`, com filtros/busca, paginacao, exportacao CSV sem XML bruto, acoes em massa, descarte com motivo obrigatorio, processamento em massa apenas de aprovados, permissoes `export_nfse_external_xml_inbox` e `bulk_manage_nfse_external_xml_inbox`, migration `0074` e UI operacional da inbox. Permanecem confirmadas as ausencias de conectores reais de e-mail/ERP, consulta Webmania automatica, manifestacao automatica, criacao direta de `NfseReceivedDocument` pela inbox, `NfseItem`, `FiscalDocument(nfse)` e `FiscalEmissionAttempt`.
...
| 3.17.0 - Fechamento do bloco NFS-e recebida | em planejamento | `03-prd-matriz-api-webmania.md`, `07-plano-de-fases-e-criterios-de-aceite.md`, `09-decisoes-arquiteturais.md`, `11-backlog-e-pendencias.md` | N/A | N/A | Somente documentacao; decidir proximo eixo fiscal |
