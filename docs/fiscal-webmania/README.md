...
Fase atual: Fase 3.14.0 - Reavaliacao apos NFS-e Recebida Completa, em planejamento documental em 2026-06-29. A Fase 3.13.1 foi validada e encerrada no checkpoint `01f0924d`, com `NfseReceivedDocumentConsultation`, migration `0071`, flag `nfse_received_consultation_enabled` e consulta GET-only implementados. XML/hash/dados extraidos seguem preservados, divergencias sao registradas sem sobrescrita destrutiva, nao ha manifestacao automatica, `NfseItem` ou `FiscalDocument(nfse)` no fluxo consultivo de recebidas.
...
| 3.14.0 - Reavaliacao apos NFS-e recebida completa | em planejamento | `03-prd-matriz-api-webmania.md`, `07-plano-de-fases-e-criterios-de-aceite.md`, `09-decisoes-arquiteturais.md`, `11-backlog-e-pendencias.md` | N/A | N/A | Somente documentacao; decidir entre lote XML, integracoes, NFS-e expandida e demais blocos fiscais |
