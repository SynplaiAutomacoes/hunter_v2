...
Fase atual: Fase 2.5.6P - Preview fiscal de debito tipo 4 implementada e validada tecnicamente em 2026-06-22, aguardando checkpoint. A Fase 2.5.6.0 selecionou debito tipo 4 como proximo candidato sem autorizar emissao. `FiscalDebitProductPreview` prepara e congela `finalidade=6`, `tipo_debito=4`, `dfe_referenciado`, produto e IBS/CBS sem criar documento, tentativa ou chamada Webmania. Emissao de debito, credito tipos 2-5, `112120`, `112140`, eventos `211xxx`, complementar tributaria, NFS-e e CT-e permanecem bloqueados.
...
| 2.5.6P - Preview fiscal debito tipo 4 | validada tecnicamente, aguardando checkpoint | `04-prd-dominio-e-modelagem.md`, `07-plano-de-fases-e-criterios-de-aceite.md` | 2026-06-22 | 2026-06-22 | Preview propria sem documento, tentativa ou gateway remoto |
