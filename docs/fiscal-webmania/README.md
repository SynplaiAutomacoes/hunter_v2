...
Fase atual: Fase 3.8.1 - Cancelamento da NFS-e Manual Nova, validada tecnicamente em 2026-06-28. A Fase 3.8.0 foi validada documentalmente no checkpoint `1faf0a9`, aprovando implementar o cancelamento da NFS-e manual nova como extensao segura do cancelamento NFS-e existente por `PUT /2/nfse/cancelar` com `{uuid, motivo}`. A implementacao reutiliza `NfseCancellation` e `nfse_cancellation`, preservando preview, emissao manual e XML original.
...
| 3.8.1 - Cancelamento NFS-e manual nova | validada tecnicamente | `05-prd-seguranca-idempotencia-webhooks.md`, `07-plano-de-fases-e-criterios-de-aceite.md`, `08-plano-de-testes-e-operacao.md` | 2026-06-28 | 2026-06-28 | Extensao segura do cancelamento NFS-e existente; checkpoint desta entrega pendente |
