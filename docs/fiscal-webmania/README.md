...
Fase atual: Fase 2.5.4 - Emissao da NF-e de credito tipo 1 por multa/juros implementada e validada tecnicamente em 2026-06-22, aguardando checkpoint. A Fase 2.5.3P foi validada no checkpoint `0d95a026`; `FiscalCreditProductPreview` aprovada e imutavel e a unica fonte permitida para o produto fiscal. O escopo implementado autoriza somente `modelo=1`, `finalidade=5` e `tipo_credito=1`. Debito, credito tipos 2-5, cancelamento de credito, `112120`, `112140`, eventos `211xxx`, complementar tributaria, NFS-e e CT-e permanecem bloqueados.
