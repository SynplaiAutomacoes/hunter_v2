...
Fase atual: Fase 3.13.1 - Consulta/Reconciliacao Auxiliar para NFS-e Recebida, validada tecnicamente em 2026-06-29. A Fase 3.13.0 foi validada documentalmente no checkpoint `d83b37dc`, decidindo implementar consulta GET-only para `NfseReceivedDocument`, sem criar documento recebido sem XML, sem substituir XML/hash/dados fiscais extraidos, sem manifestar automaticamente, sem criar `NfseItem` e sem criar `FiscalDocument(nfse)`. Manifestacao da NFS-e manual continua adiada.
...
| 3.13.1 - Consulta auxiliar NFS-e recebida | validada tecnicamente | `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `06-prd-ux-permissoes-e-workflows.md`, `08-plano-de-testes-e-operacao.md` | 2026-06-29 | 2026-06-29 | Migration `0071`; GET-only consultivo; nao substitui XML/dados extraidos; sem manifestacao automatica |
