...
Fase atual: Fase 2.5.3P - Validacao fiscal do produto de multa/juros implementada e validada, aguardando aprovacao do checkpoint, sem transmissao remota. `FiscalCreditProductPreview` armazena revisoes locais com quantidade, valor unitario, total e CFOP explicitamente confirmados; o IBS/CBS vem somente da base aprovada. A Fase 2.5.3.0 foi aprovada e a 2.5.2P validada no checkpoint `638d4c12`. Emissao de credito/debito, `112120`, `112140`, eventos `211xxx`, complementar tributaria, NFS-e e CT-e permanecem bloqueados.
