...
Fase atual: Fase 2.4D.5.2 - Cancelamento do Evento IBS/CBS `112130` validado. A Fase 2.4D.5.1 foi validada no checkpoint `a8a43011`; emissao do `112130`, emissao/cancelamento do `112110` e emissao/cancelamento do `112150` permanecem intactos. Eventos `112120`, `112140`, `211xxx`, credito/debito, complementar tributaria, NFS-e e CT-e permanecem fora de escopo.
...
| 2.4D.5.2 - Cancelamento evento IBS/CBS 112130 | validada | `07-plano-de-fases-e-criterios-de-aceite.md`                         | 2026-06-18      | 2026-06-18  | Somente cancelamento do evento 112130 autorizado; cancelamento generico e demais eventos bloqueados |
