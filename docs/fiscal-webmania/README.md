...
Fase atual: Fase 3.4.1 - Substituicao Remota de NFS-e Legada, implementada e validada tecnicamente. A Fase 3.4P foi validada no checkpoint `747b6750a62d6ed59bed84c4616f89793c4247b4`; `NfseSubstitutionPreview` aprovada e imutavel e pre-condicao obrigatoria. O POST usa apenas `ambiente/codigo_verificacao/motivo/rps`; manifestacao e emissao manual nova continuam fora de escopo.
