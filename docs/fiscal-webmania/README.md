...
Fase atual: Fase 3.17.1 - Auditoria Tecnica/Fiscal Geral, em auditoria documental/tecnica em 2026-06-30. A Fase 3.17.0 foi validada documentalmente e encerrada no checkpoint `424a3c2a`, escolhendo a auditoria geral como proximo eixo antes de novos dominios fiscais. Permanecem confirmadas as ausencias de conectores reais de e-mail/ERP, consulta Webmania automatica, manifestacao automatica, criacao direta de `NfseReceivedDocument` pela inbox, `NfseItem`, `FiscalDocument(nfse)`, `FiscalEmissionAttempt`, CT-e, MDF-e, NFCom, DC-e, eventos IBS/CBS pendentes, creditos/debitos pendentes e complementar tributaria.
...
| 3.17.1 - Auditoria tecnica/fiscal geral | em auditoria | `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `06-prd-ux-permissoes-e-workflows.md`, `07-plano-de-fases-e-criterios-de-aceite.md`, `08-plano-de-testes-e-operacao.md`, `09-decisoes-arquiteturais.md`, `11-backlog-e-pendencias.md` | N/A | N/A | Sem funcionalidade nova; revisar consistencia, seguranca, idempotencia, testes e documentacao |
