...
Fase atual: Fase 3.9.1 - Substituicao da NFS-e Manual Nova, validada tecnicamente em 2026-06-29, com checkpoint criado nesta entrega. A Fase 3.9.0 foi validada documentalmente no checkpoint `21d684e7`, decidindo implementar a substituicao da NFS-e manual como extensao segura do fluxo atual de substituicao NFS-e. A implementacao reutiliza `NfseSubstitutionPreview`, `NfseSubstitution`, `nfse_substitution`, `POST /2/nfse/substituir`, webhook, reconciliacao e idempotencia ja validados, adaptando elegibilidade para `NfseManualEmission.nfse_item` e preservando XML original/payload da emissao manual.
...
| 3.9.1 - Substituicao NFS-e manual nova | validada tecnicamente | `03-prd-matriz-api-webmania.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `08-plano-de-testes-e-operacao.md` | 2026-06-29 | 2026-06-29 | Extensao segura de `NfseSubstitutionPreview`/`NfseSubstitution`; checkpoint criado nesta entrega |
