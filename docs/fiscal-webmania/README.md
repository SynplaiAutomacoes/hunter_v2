...
Fase atual: Fase 3.6.0 - Planejamento Tecnico da Manifestacao de NFS-e Padrao Nacional, em planejamento documental. A Fase 3.5.0 foi validada e encerrada com a decisao aprovada de priorizar manifestacao NFS-e Padrao Nacional e manter emissao manual nova, NFS-e expandida ampla, CT-e, MDF-e, NFCom, DC-e, eventos IBS/CBS pendentes, creditos 2-5, debitos restantes e complementar tributaria adiados. Cancelamento e substituicao de NFS-e legada ja foram implementados; manifestacao ainda nao possui implementacao funcional.
...
| 3.6.0 - Planejamento manifestacao NFS-e Padrao Nacional | em planejamento | `03-prd-matriz-api-webmania.md`, `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `07-plano-de-fases-e-criterios-de-aceite.md` | N/A | N/A | Somente documental; sem codigo funcional |
