...
Fase atual: Fase 2.5.2P - Base monetaria e comercial por item implementada e validada, aguardando aprovacao do checkpoint. A Fase 2.5.2.0 foi aprovada com decisao de adiar toda emissao de credito/debito; credito tipo 1 (multa/juros) permanece o melhor candidato futuro. `FiscalReferencedBasisItem` congela os dados historicos e a composicao explicita, sem emissao, tentativa remota ou gateway. `112120`, `112140`, eventos `211xxx`, complementar tributaria, NFS-e e CT-e permanecem fora de escopo.
