...
Fase atual: Fase 2.4D.6.0 - Planejamento final dos Eventos IBS/CBS `112120` e `112140` documentado, aguardando aprovacao. A Fase 2.4D.5.2 foi validada no checkpoint `d7a82117`; o ciclo completo validado cobre emissao/cancelamento de `112110`, `112150` e `112130`. Eventos `211xxx`, credito/debito, complementar tributaria, NFS-e e CT-e permanecem fora de escopo.
...
| 2.4D.6.0 - Planejamento final 112120/112140 | documentada | `07-plano-de-fases-e-criterios-de-aceite.md`                         | N/A             | 2026-06-18  | Decisao recomendada: adiar ambos e aprovar fase preparatoria |
