...
Fase atual: Fase 3.15.2 - Caixa de Entrada Externa de XML para NFS-e Recebida, em implementacao controlada em 2026-06-30. A Fase 3.15.1 foi validada documentalmente e encerrada no checkpoint `5882cd4e`, decidindo implementar inbox local/manual/assistida para XMLs candidatos. A inbox nao e documento fiscal, nao consulta Webmania, nao manifesta, nao implementa conector real de e-mail/ERP e so envia XML aprovado por usuario ao pipeline validado de lote XML.
...
| 3.15.2 - Caixa de entrada externa XML NFS-e recebida | em implementacao | `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `06-prd-ux-permissoes-e-workflows.md`, `08-plano-de-testes-e-operacao.md` | 2026-06-30 | N/A | Inbox local/manual, sem e-mail/ERP real, sem Webmania automatica e sem manifestacao automatica |
