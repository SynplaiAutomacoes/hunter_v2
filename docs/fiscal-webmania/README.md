...
Fase 2.4.0 aprovada documentalmente. A Fase 2.4A+B foi autorizada para combinar configuracao/modelagem IBS/CBS em classes fiscais NF-e/NFC-e com adequacao dos fluxos normais ja emissores: NF-e normal legada e NFC-e manual simples. A combinacao e obrigatoria porque apenas criar campos locais sem bloquear/emissoes normais deixaria o produto exposto a rejeicao fiscal em producao. Derivados existentes, eventos IBS/CBS, credito/debito, NFS-e e CT-e permanecem pendentes e fora do escopo desta fase.
...
| 2.4A+B - Base IBS/CBS e emissoes normais | validada | `07-plano-de-fases-e-criterios-de-aceite.md`                         | 2026-05-29      | 2026-05-29  | Derivados, eventos IBS/CBS e credito/debito pendentes |
| 2.4C - Derivados com IBS/CBS | nao iniciada | `07-plano-de-fases-e-criterios-de-aceite.md`                         | N/A             | N/A         | Devolucao/estorno, complementar e ajuste pendentes |
