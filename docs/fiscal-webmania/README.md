...
Fase atual: Fase 2.5.1P - Preparacao de Base Fiscal Referenciada para Credito/Debito implementada e validada. A Fase 2.5.1.0 foi aprovada com decisao de adiar todos os tipos de credito/debito. A base interna prepara documento/item referenciado, snapshot IBS/CBS imutavel, hipotese e vinculos auditaveis, sem emitir NF-e de credito/debito. `112120`, `112140`, eventos `211xxx`, complementar tributaria, NFS-e e CT-e permanecem fora de escopo.
...
| 2.5.1P - Base fiscal referenciada | validada | `04-prd-dominio-e-modelagem.md`, `07-plano-de-fases-e-criterios-de-aceite.md` | 2026-06-19 | 2026-06-19 | Base auditavel pronta; emissao continua bloqueada |
