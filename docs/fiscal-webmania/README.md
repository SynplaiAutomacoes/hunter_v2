...
Fase atual: Fase 3.11.0 - Planejamento Tecnico da NFS-e Recebida/Importada de Terceiros, em planejamento documental em 2026-06-29. A Fase 3.10.0 foi validada documentalmente no checkpoint `8d5c7192`, adiando a manifestacao da NFS-e manual porque o endpoint `POST /2/nfse/manifestar` existe para Padrao Nacional por tomador/intermediario, mas o papel fiscal da oficina em NFS-e manual propria permanece ambiguo. A decisao aprovada prioriza planejar NFS-e recebida/importada de terceiros antes de qualquer manifestacao sobre esses documentos.
...
| 3.11.0 - Planejamento NFS-e recebida/importada | em planejamento | `03-prd-matriz-api-webmania.md`, `04-prd-dominio-e-modelagem.md`, `07-plano-de-fases-e-criterios-de-aceite.md` | N/A | N/A | Somente documental; planejar registro seguro de documento recebido |
