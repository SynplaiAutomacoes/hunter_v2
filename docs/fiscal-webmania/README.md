...
Fase atual: Fase 3.15.1 - Planejamento de Integracao E-mail/ERP para XML NFS-e, em planejamento documental em 2026-06-29. A Fase 3.15.0 foi validada documentalmente e encerrada no checkpoint `4815728b`, decidindo planejar uma caixa de entrada externa de XML como dominio local intermediario antes de qualquer conector real. A futura integracao deve apenas entregar XMLs candidatos ao pipeline validado de NFS-e recebida, sem consulta Webmania automatica, manifestacao automatica, documento sem XML, `NfseItem`, `FiscalDocument(nfse)` ou `FiscalEmissionAttempt`.
...
| 3.15.1 - Planejamento integracao e-mail/ERP XML NFS-e | em planejamento | `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `06-prd-ux-permissoes-e-workflows.md`, `07-plano-de-fases-e-criterios-de-aceite.md`, `08-plano-de-testes-e-operacao.md` | N/A | N/A | Somente documentacao; planejar caixa de entrada externa, sem conector real |
