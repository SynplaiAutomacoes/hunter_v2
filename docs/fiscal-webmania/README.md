...
Fase atual: Fase 3.14.1 - Importacao em Lote de XML de NFS-e Recebida, validada tecnicamente em 2026-06-29. A Fase 3.14.0 foi validada documentalmente no checkpoint `18d1840d`, decidindo implementar lote local baseado exclusivamente em XML. A 3.14.1 adicionou lote persistido, relatorio por arquivo, importacao parcial segura, bloqueio de duplicidades por hash/UUID/identificador e limites conservadores, sem consulta Webmania automatica, sem manifestacao automatica, sem documento sem XML, sem `NfseItem`, sem `FiscalDocument(nfse)` e sem `FiscalEmissionAttempt`.
...
| 3.14.1 - Importacao em lote XML NFS-e recebida | validada tecnicamente | `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `06-prd-ux-permissoes-e-workflows.md`, `08-plano-de-testes-e-operacao.md` | 2026-06-29 | 2026-06-29 | Migration `0072`; lote persistido; relatorio por arquivo; XML-only; sem Webmania/manifestacao automatica |
