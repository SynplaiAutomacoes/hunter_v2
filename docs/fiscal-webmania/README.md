...
Fase atual: Fase 3.4P - Preview Imutavel de Substituicao de NFS-e Legada, implementada e validada tecnicamente. A Fase 3.4.0 foi aprovada com a decisao de congelar e aprovar o novo RPS antes de qualquer chamada remota. A divergencia oficial entre `uuid` e `ambiente/codigo_verificacao/motivo/rps` permanece bloqueante para o futuro POST; manifestacao e emissao manual nova continuam fora de escopo.
...
| 3.4.0 - Planejamento da substituicao NFS-e | em planejamento | `03-prd-matriz-api-webmania.md`, `04-prd-dominio-e-modelagem.md`, `09-decisoes-arquiteturais.md` | N/A | 2026-06-23 | Decisao: preparar preview imutavel do novo RPS antes da operacao funcional |
