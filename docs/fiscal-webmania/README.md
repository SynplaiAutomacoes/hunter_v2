...
Fase atual: Fase 3.15.0 - Reavaliacao do Roadmap apos Consolidacao de NFS-e Recebida, em planejamento documental em 2026-06-29. A Fase 3.14.1 foi validada e encerrada no checkpoint `b53e862b`, com importacao em lote de XML de NFS-e recebida, `NfseReceivedImportBatch`, `NfseReceivedImportBatchItem`, migration `0072`, relatorio persistido por arquivo, importacao parcial segura, duplicidade por hash/UUID/identificador inclusive dentro do lote e limites de quantidade/tamanho. Permanecem confirmadas as ausencias de consulta Webmania automatica, manifestacao automatica, `NfseItem`, `FiscalDocument(nfse)` e `FiscalEmissionAttempt`.
...
| 3.15.0 - Reavaliacao apos consolidacao NFS-e recebida | em planejamento | `03-prd-matriz-api-webmania.md`, `07-plano-de-fases-e-criterios-de-aceite.md`, `09-decisoes-arquiteturais.md`, `11-backlog-e-pendencias.md` | N/A | N/A | Somente documentacao; decidir entre e-mail/ERP, consulta ampliada, NFS-e expandida e demais blocos fiscais |
