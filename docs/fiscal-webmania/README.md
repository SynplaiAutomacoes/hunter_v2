...
Fase atual: Fase 3.1 - Estabilizacao NFS-e Legado, Capacidades Municipais e `atualizado_em`, implementada e validada em 2026-06-23. A Fase 3.0 foi aprovada; cancelamento idempotente, substituicao, manifestacao e emissao manual nova permanecem fora de escopo.
