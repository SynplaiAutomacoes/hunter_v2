...
Fase atual: Fase 3.6.1 - Manifestacao de NFS-e Padrao Nacional, em implementacao tecnica. A Fase 3.6.0 foi validada documentalmente no checkpoint `0a8dd0c9`. A implementacao autorizada e restrita a `POST /2/nfse/manifestar` para NFS-e local com Padrao Nacional confirmado, sem emissao manual nova, sem NFS-e recebida/importada de terceiros, sem desfazimento/cancelamento de manifestacao e sem novas familias fiscais.
...
| 3.6.1 - Manifestacao NFS-e Padrao Nacional | em implementacao | `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `06-prd-ux-permissoes-e-workflows.md`, `08-plano-de-testes-e-operacao.md` | 2026-06-26 | N/A | Restrita a NFS-e local Padrao Nacional |
