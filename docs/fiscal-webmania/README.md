...
Fase atual: Fase 3.11.1 - Registro Local de NFS-e Recebida por XML, implementada e validada tecnicamente em 2026-06-29. A Fase 3.11.0 foi validada documentalmente no checkpoint `6f36f7fc`, decidindo criar registro local de NFS-e recebida/importada de terceiros por upload de XML validado. Consulta Webmania por identificador permanece apenas apoio/reconciliacao futura; manifestacao funcional, `NfseItem`, `FiscalDocument(nfse)` e chamadas remotas ficam fora desta fase.
