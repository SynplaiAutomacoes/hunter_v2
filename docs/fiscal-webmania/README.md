...
Fase atual: Fase 3.7.1 - Emissao Manual Nova de NFS-e a partir de Preview Aprovada, validada tecnicamente em 2026-06-28. A Fase 3.7P foi validada e encerrada no checkpoint `1fdded4e`, com `NfseManualEmissionPreview` implementada como pre-condicao obrigatoria. A emissao manual nova transmite exclusivamente o payload congelado da preview aprovada por `POST /2/nfse/emissao`; cancelamento, substituicao e manifestacao da nova NFS-e continuam fora do escopo inicial.
...
| 3.7.1 - Emissao manual nova NFS-e | validada tecnicamente | `03-prd-matriz-api-webmania.md`, `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md`, `06-prd-ux-permissoes-e-workflows.md`, `08-plano-de-testes-e-operacao.md` | 2026-06-28 | 2026-06-28 | Somente a partir de preview aprovada; cancelamento/substituicao/manifestacao fora do escopo |
