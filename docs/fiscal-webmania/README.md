...
Fase atual: Fase 2.5.7 - Emissao da NF-e de debito tipo 4 validada tecnicamente em 2026-06-22, aguardando somente o checkpoint desta entrega. A emissao fica restrita a multa/juros, origem local e `FiscalDebitProductPreview` aprovada. Cancelamento, demais tipos de debito, creditos 2-5, eventos pendentes, complementar tributaria, NFS-e e CT-e permanecem bloqueados.
...
| 2.5.7 - Emissao debito tipo 4 | validada tecnicamente | `04-prd-dominio-e-modelagem.md`, `05-prd-seguranca-idempotencia-webhooks.md` | 2026-06-22 | 2026-06-22 | 276 testes fiscais dirigidos; checkpoint desta entrega pendente |
