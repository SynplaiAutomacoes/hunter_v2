...
Fase atual: Fase 2.5.5 - Cancelamento da NF-e de credito tipo 1 implementado e validado tecnicamente em 2026-06-22, aguardando checkpoint. A Fase 2.5.4 foi validada no checkpoint `a79f6b7f`; credito tipo 1 agora possui ciclo de emissao e cancelamento padrao NF-e. Debito, credito tipos 2-5, `112120`, `112140`, eventos `211xxx`, complementar tributaria, NFS-e e CT-e permanecem bloqueados.
