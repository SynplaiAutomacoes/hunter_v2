...
Fase atual: Fase 2.5.8 - Cancelamento da NF-e de debito tipo 4 validada tecnicamente em 2026-06-22, aguardando o checkpoint desta entrega. A Fase 2.5.7 foi validada no checkpoint `9214150d`; o debito tipo 4 agora possui ciclo de emissao e cancelamento padrao completo. Demais tipos de debito, creditos 2-5, eventos pendentes, complementar tributaria, NFS-e e CT-e permanecem bloqueados.
...
| 2.5.8 - Cancelamento debito tipo 4 | validada tecnicamente | `05-prd-seguranca-idempotencia-webhooks.md`, `07-plano-de-fases-e-criterios-de-aceite.md` | 2026-06-22 | 2026-06-22 | 286 testes fiscais dirigidos; checkpoint desta entrega pendente |
