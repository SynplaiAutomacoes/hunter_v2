...
Fase atual: Fase 3.13.0 - Reavaliacao do Roadmap apos Fechamento do Bloco NFS-e, em planejamento documental em 2026-06-29. A Fase 3.12.1 foi validada e encerrada no checkpoint `6cc3a788`, com manifestacao de NFS-e recebida implementada como extensao segura de `NfseManifestation` para origem `NfseReceivedDocument`, migration `0070`, payload restrito em `POST /2/nfse/manifestar`, bloqueios por papel fiscal, UUID, XML/hash, status, Padrao Nacional, capability e duplicidade, sem criar `NfseItem` ou `FiscalDocument(nfse)`. Manifestacao da NFS-e manual continua adiada.
...
| 3.13.0 - Reavaliacao pos-bloco NFS-e | em planejamento | `03-prd-matriz-api-webmania.md`, `07-plano-de-fases-e-criterios-de-aceite.md`, `09-decisoes-arquiteturais.md` | N/A | 2026-06-29 | Somente documentacao; reavaliar consulta auxiliar, lote, integracoes, NFS-e expandida e demais blocos fiscais |
