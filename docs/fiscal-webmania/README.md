...
Fase atual: Fase 3.7P - Preview Imutavel de Emissao Manual Nova de NFS-e, validada localmente em 2026-06-27. A Fase 3.7.0 foi validada documentalmente no checkpoint `1b60125c`, aprovando emissao manual nova de NFS-e somente apos preview/snapshot imutavel. Transmissao Webmania por `POST /2/nfse/emissao` continua bloqueada.
...
| 3.7P - Preview emissao manual nova NFS-e | validada localmente | `04-prd-dominio-e-modelagem.md`, `06-prd-ux-permissoes-e-workflows.md`, `08-plano-de-testes-e-operacao.md` | 2026-06-27 | 2026-06-27 | Sem transmissao Webmania |
